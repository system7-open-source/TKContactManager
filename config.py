...
#                 'expression': 'python:object.getTypeInfo().getId() \
#                                                       == "MyType"'}]
...
generic_setup_import_steps = ['typeinfo', 'jsregistry', 'cssregistry']
##/code-section config-bottom


# Load custom configuration not managed by ArchGenXML
try:
    from Products.TKContactManager.AppConfig import *
except ImportError:
    pass
